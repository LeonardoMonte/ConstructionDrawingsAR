...
public class PolyExtruderDemo : MonoBehaviour
{
    ...
    public float extrusionHeight = 1000.0f;
    ...
    {
          new Vector2(329.0f, 326.0f),
          new Vector2(328.0f, 327.0f),
          new Vector2(327.0f, 327.0f),
          new Vector2(326.0f, 328.0f),
          new Vector2(325.0f, 328.0f),
          new Vector2(324.0f, 329.0f),
          new Vector2(324.0f, 330.0f),
          new Vector2(323.0f, 331.0f),
          new Vector2(323.0f, 332.0f),
          new Vector2(322.0f, 333.0f),
          new Vector2(321.0f, 432.0f),
          new Vector2(320.0f, 433.0f),
          new Vector2(320.0f,467.0f),
          new Vector2(319.0f, 468.0f),
          new Vector2(319.0f, 486.0f),
          new Vector2(320.0f, 487.0f),
          new Vector2(320.0f, 488.0f),
          new Vector2(321.0f, 489.0f),
          new Vector2(329.0f, 489.0f),
          new Vector2(329.0f, 488.0f),
          new Vector2(330.0f, 487.0f),
          new Vector2(330.0f, 479.0f),
          new Vector2(331.0f, 478.0f),
          new Vector2(331.0f, 451.0f),
          new Vector2(332.0f, 450.0f),
          new Vector2(332.0f, 415.0f),
          new Vector2(333.0f, 414.0f),
          new Vector2(333.0f, 379.0f),
          new Vector2(334.0f, 378.0f),
          new Vector2(334.0f, 345.0f),
          new Vector2(335.0f, 344.0f),
          new Vector2(335.0f, 343.0f),
          new Vector2(339.0f, 339.0f),
          new Vector2(340.0f, 339.0f),
          new Vector2(341.0f, 338.0f),
          new Vector2(367.0f, 338.0f),
          new Vector2(368.0f, 339.0f),
          new Vector2(384.0f, 339.0f),
          new Vector2(384.0f, 331.0f),
          new Vector2(383.0f, 330.0f),
          new Vector2(382.0f, 330.0f),
          new Vector2(380.0f, 328.0f),
          new Vector2(379.0f, 328.0f),
          new Vector2(378.0f, 327.0f),
          new Vector2(350.0f, 327.0f),
          new Vector2(349.0f, 326.0f),
    };
